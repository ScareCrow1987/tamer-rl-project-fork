...
import edu.utexas.cs.tamerProject.environments.cartarm.messages.StateRequest;
...
public class CartArmVisualizer extends AbstractVisualizer implements ValueFunctionDataProvider, AgentOnValueFunctionDataProvider, GlueStateProvider {
    ...
    public CartArmVisualizer(TinyGlue glueState, DynamicControlTarget theControlTarget) {
        super();
    ...
    protected void setupVizComponents() {
        ...
        SelfUpdatingVizComponent cartArmComponent = new CartArmComponent(this);
        ...
        super.addVizComponentAtPositionWithSize(cartArmComponent, 0, 0, 1.0, 1.0);
